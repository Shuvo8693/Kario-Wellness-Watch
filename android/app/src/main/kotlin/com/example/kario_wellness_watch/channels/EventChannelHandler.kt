...
class EventChannelHandler(private val starmaxManager: StarmaxManager) : EventChannel.StreamHandler {
...
) : EventChannel.StreamHandler, StarmaxManager.UiListener {

    private val TAG = "EventChannelHandler"
    private var eventSink: EventChannel.EventSink? = null

    override fun onListen(arguments: Any?, events: EventChannel.EventSink?) {
        Log.d(TAG, "onListen")
        eventSink = events
        starmaxManager.setUiListener(this)
    }

    override fun onCancel(arguments: Any?) {
        Log.d(TAG, "onCancel")
        starmaxManager.setUiListener(null)
        eventSink = null
    }
